...
// FIXED: Responsive display — removed inline style vs Tailwind hidden conflict
// FIXED: Direction forced LTR on all nav elements
// FIXED: Mobile menu properly hidden on desktop and vice versa
'use client';
import { useEffect, useRef, useState } from 'react';
import Link from 'next/link';
import { useTheme } from 'next-themes';
import {
  Globe, Menu, X, Sun, Moon, User, LogOut,
  ChevronDown, LayoutDashboard, Calendar, Heart, Settings,
} from 'lucide-react';
