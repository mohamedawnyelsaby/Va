...
export function PopularDestinations({ locale }: { locale: string }) {
  ...
  return (
    <section ref={sectionRef} style={{ background: 'var(--vg-bg-surface)', padding: 'clamp(4rem,8vw,7rem) 0' }}>
      ...
      {/* Grid — كل card مغلّفة بـ TiltCard */}
      <div style={{
          ...
          >
            ...
            >
              ...
              <div style={{
                ...
                background: 'linear-gradient(to top, rgba(3,2,10,0.9) 0%, transparent 100%)',
                padding: '2rem 1.2rem 1.1rem', zIndex: 2,
              }}>
                <div style={{
                  fontFamily: 'var(--font-cormorant)', fontSize: '1.6rem',
                  fontWeight: 300, color: 'var(--vg-text)', lineHeight: 1,
                }}>
                  {dest.city}
                </div>
                <div style={{
                  ...
                  color: 'var(--vg-text-3)', marginTop: '0.3rem',
                }}>
                  {dest.country}
                </div>
              </div>
