...
export default function SignUpPage() {
  ...
  const handlePiNetworkSignup = () => {
    toast({ title: 'Coming Soon', description: 'Pi Network signup will be available soon' });
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800 py-8">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Join Va Travel and start your journey</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="space-y-3">
            ...
            <Button type="button" variant="outline" className="w-full" onClick={handlePiNetworkSignup}>
